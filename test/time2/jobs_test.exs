defmodule Time2.JobsTest do
  ...
  describe "jobs" do
    ...
    @valid_attrs %{budget: 42, description: "some description", job_code: "some job_code", name: "some name"}
    @update_attrs %{budget: 43, description: "some updated description", job_code: "some updated job_code", name: "some updated name"}
